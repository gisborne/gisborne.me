...
If we want AI-driven prosperity to show up in living standards rather than land inflation, housing reform is not ancillary policy. (It is AI policy. It is also [social policy](https://www.anu.edu.au/news/all-news/cost-of-living-pressures-sees-social-cohesion-hit-record-low)).
...
[AI agents do not use the internet the way humans do](https://spectrum.ieee.org/ai-agent-economy).
...
- [Increased returns to scale](https://www.goldmansachs.com/insights/articles/ai-may-favor-big-tech-incumbents) (large models, data advantages, compute access);
- Reduce [internal](https://ascelibrary.org/doi/abs/10.1061/JMENEA.MEENG-7079) and [external](https://www.sciencedirect.com/science/article/pii/S1059056025007609) coordination costs; and
- Reduced cost of managing complexity.

But AI also allows small firms to [access high-quality tax, legal, investment, and management advice]((https://andeglobal.org/ai-is-moving-fast-small-businesses-cant-be-left-behind/)) without needing to grow large bureaucracies.
